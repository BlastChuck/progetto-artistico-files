const tasks = [
  ...
  { name: 'Analisi dei requisiti', owner: 'Viola Scappazzoni', status: 'completed', start: '2026-03-25', end: '2026-03-30' },
  ...
  { name: 'Popolamento database', owner: 'Giorgio Astolfi', status: 'completed', start: '2026-04-20', end: '2026-04-20' },
  { name: 'Test', owner: 'Andrea Burlui', status: 'completed', start: '2026-04-22', end: '2026-04-27' },
  { name: 'Presetazione', owner: 'Giorgio Astolfi', status: 'completed', start: '2026-04-20', end: '2026-05-03' }
];
